...
export function WhyVoiceSection() {
  return (
    <section id="why-voice" className="scroll-mt-24 border-y border-[var(--color-border)] bg-[var(--color-bg-soft)] py-16 md:py-24 lg:py-28">
        ...
        <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-3">
          {landingContent.whyVoice.points.map((point) => (
            ...
            >
              ...
              <h3 className="font-display mt-4 text-xl font-light text-[var(--color-text-primary)]">{point.title}</h3>
