...
export function TrustStrip() {
  return (
    <section className="scroll-mt-24 border-y border-[var(--color-border)] bg-[var(--color-surface-inset)]">
      <Container className="grid gap-3 py-4 sm:grid-cols-2 lg:grid-cols-5">
        {landingContent.hero.trustScaffold.map((item) => (
          <div key={item.label} className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-3">
